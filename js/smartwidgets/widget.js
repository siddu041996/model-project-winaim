/*  Modified By : Devaraj S
    Modified On : 14-06-2016 1307 
    Description : In Widget export button we added as per the new requirement of Dashboard. */
...
(function ($, window, document, undefined) {
    ...
    function Plugin(element, options) {
        ...
        this.exportClass = this.o.exportClass.split('|');
        ...
        init: function () {
            ...
            self.widget.each(function () {
                ...
                if (!thisHeader.parent()
                    ...
                    /**
                     * Add a export button to the widget header (if set to true).
                     **/
                    if (self.o.exportButton === true && tWidget.data('widget-exportButton') ===
                        undefined) {
                        var exportBtn =
                            '<a href="javascript:void(0);" class="button-icon jarviswidget-export-btn tooltipped" data-tooltip="Export" data-position="bottom" data-delay="50"><i class="' +
                            self.exportClass[0] + '"></i></a>';
                    } else {
                        exportBtn = '';
                    }
                    ...
                    if (self.o.deleteButton === true && tWidget.data('widget-deletebutton') ===
                        undefined) {
                        var deleteBtn =
                            '<a href="javascript:void(0);" class="button-icon jarviswidget-delete-btn tooltipped" data-tooltip="Delete" data-position="bottom" data-delay="50"><i class="' +
                    ...
                    if (self.o.editButton === true && tWidget.data('widget-editbutton') === undefined) {
                        var editBtn =
                            '<a href="javascript:void(0);" class="button-icon jarviswidget-edit-btn tooltipped" data-tooltip="Filter" data-position="bottom" data-delay="50"><i class="' +
                    ...
                    if (self.o.fullscreenButton === true && tWidget.data('widget-fullscreenbutton') ===
                        undefined) {
                        var fullscreenBtn =
                            '<a href="javascript:void(0);" class="button-icon jarviswidget-fullscreen-btn tooltipped" data-tooltip="Maximize / Minimize" data-position="bottom" data-delay="50"><i class="' +
                    ...
                    if (self.o.toggleButton === true && tWidget.data('widget-togglebutton') ===
                        ...
                        var toggleBtn =
                            '<a href="#" class="button-icon jarviswidget-toggle-btn tooltipped" data-tooltip="Expand / Collapse" data-position="bottom" data-delay="50"><i class="' +
                            toggleSettings + '"></i></a>';
                    } else {
                        toggleBtn = '';
                    }
        ...
        _clickEvents: function () {
            ...
            self.widget.on(clickEvent, '.jarviswidget-fullscreen-btn', function (e) {
                ...
                if ($('#jarviswidget-fullscreen-mode')
                    ...
                    thisWidget.wrap('<div id="jarviswidget-fullscreen-mode"/>')
                        ...
                        .parents(self.pwCtrls)
                        .children('.jarviswidget-toggle-btn')
                        .hide();
            ...
            self.widget.on(clickEvent, '.jarviswidget-edit-btn', function (e) {
                ...
                if (tWidget.find(self.o.editPlaceholder)
                    ...
                    setTimeout(function () {
                        if ($(".scroll-content") != undefined && $(".scroll-content") != null && $(".scroll-content").length > 0) {
            ...
            /**
             * Allow users to export the widgets.
             **/
            self.widget.on(clickEvent, '.jarviswidget-export-btn', function (e) {
                var tWidget = $(this)
                    .parents(self.o.widgets);
                /**
                 * Run the callback function.
                 **/
                if (typeof self.o.onExport == 'function') {
                    self.o.onExport(this, tWidget);
                }
                //e.preventDefault();
            });
        },
    ...
    $.fn[pluginName].defaults = {
        ...
        fullscreenClass: 'fa fa-expand | normalscreen-10',
        fullscreenDiff: 3,
        ...
        exportButton: true,
        exportClass: 'pencil-10 | delete-10',
        exportSpeed: 200,
        labelError: 'Sorry but there was a error:',
        labelUpdated: 'Last Update:',
        labelRefresh: 'Refresh',
        labelDelete: 'Delete widget:',
        labelExport: 'Export widget:',
        afterLoad: function () {},
        rtl: false,
        onChange: function () {},
        onSave: function () {},
